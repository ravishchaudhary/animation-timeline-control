  ...
  function Timeline() {
    ...
    timeline_defineProperty(_this, "_generateViewModel", function () {
      ...
      rows.forEach(function (row, index) {
        ...
        var currentRowY = rowAbsoluteHeight - (_this._scrollContainer ? _this._scrollContainer.scrollTop : 0) + marginBottom;
    ...
    timeline_defineProperty(_this, "_renderKeyframe", function (ctx, keyframeViewModel) {
      var _row$style, _row$style2, _keyframeViewModel$gr;
      ...
      if ((_row$style = row.style) !== null && _row$style !== void 0 && _row$style.height && size.height && ((_row$style2 = row.style) === null || _row$style2 === void 0 ? void 0 : _row$style2.height) > size.height) {
        var _row$style3;
        // Centering the keyframe
        y = y + (((_row$style3 = row.style) === null || _row$style3 === void 0 ? void 0 : _row$style3.height) - size.height) / 2;
      }
    ...
    timeline_defineProperty(_this, "setDuration", function (val) {
