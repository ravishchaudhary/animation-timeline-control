...
var Timeline = /*#__PURE__*/function (_TimelineEventsEmitte) {
  ...
  function Timeline() {
    ...
    timeline_defineProperty(_this, "_handleKeyDown", function (event) {
      ...
      _get((_this, timeline_getPrototypeOf(Timeline.prototype)), "emit", _this).call(_this, TimelineEvents.KeyDown, event);
    });
    ...
    timeline_defineProperty(_this, "_renderTimeline", function () {
      ...
      _this._ctx.save();
      try {
        var _this$_options9, _this$_options10;
        ...
        _this._renderTimelineCap(timeLinePosEnd, 0, (_this$_options10 = _this._options) === null || _this$_options10 === void 0 || (_this$_options10 = _this$_options10.timelineStyle) === null || _this$_options10 === void 0 ? void 0 : _this$_options10.durationCapStyle);
    ...
    timeline_defineProperty(_this, "_filterDraggableElements", function (elements) {
      ...
      var filteredElements = elements.filter(function (element) {
        ...
        if (element.type === TimelineElementType.Keyframe) {
          ...
          if (((_this$_options11 = _this._options) === null || _this$_options11 === void 0 ? void 0 : _this$_options11.timelineDraggable) === false) {
            return false;
          }
    ...
    timeline_defineProperty(_this, "elementFromPoint", function (pos, clickRadius, onlyTypes) {
      ...
      var width = 0;
      var timelineStyle = (_this$_options12 = _this._options) === null || _this$_options12 === void 0 ? void 0 : _this$_options12.timelineStyle;
      if (timelineStyle) {
