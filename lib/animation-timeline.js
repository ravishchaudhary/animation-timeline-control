      ...
      try {
        ...
        viewModel.rowsViewModels.forEach(function (rowViewModel) {
          ...
          if (bounds !== null && bounds !== void 0 && bounds.rect && (_rowViewModel$model$k = rowViewModel.model.keyframes) !== null && _rowViewModel$model$k !== void 0 && (_rowViewModel$model$k = _rowViewModel$model$k[0].metadata.frames) !== null && _rowViewModel$model$k !== void 0 && _rowViewModel$model$k[0]) {
            var _ref, _rowViewModel$model$s, _rowViewModel$model$s2, _this$_options$rowsSt, _rowViewModel$model$k2, _rowViewModel$model$k3, _rowViewModel$model$k4, _rowViewModel$model$k5, _this$_durationVal;
            ...
            if (startPixelVal > 0) {
              ...
              _this._ctx.fillRect(_rect.x + ((_this$_options$leftMa = _this._options.leftMargin) !== null && _this$_options$leftMa !== void 0 ? _this$_options$leftMa : 0), _rect.y, startPixelVal, _rect.height);
            }
            if (endPixelVal < durationPixelVal) {
              var _this$_options$leftMa2;
              _this._ctx.fillRect(_rect.x + ((_this$_options$leftMa2 = _this._options.leftMargin) !== null && _this$_options$leftMa2 !== void 0 ? _this$_options$leftMa2 : 0) + endPixelVal, _rect.y, durationPixelVal - endPixelVal, _rect.height);
            }
          }
        });
      } finally {
