      ...
      try {
        ...
        viewModel.rowsViewModels.forEach(function (rowViewModel) {
          ...
          if (bounds !== null && bounds !== void 0 && bounds.rect && (_rowViewModel$model$k = rowViewModel.model.keyframes) !== null && _rowViewModel$model$k !== void 0 && (_rowViewModel$model$k = _rowViewModel$model$k[0].metadata.frames) !== null && _rowViewModel$model$k !== void 0 && _rowViewModel$model$k[0]) {
            var _rowViewModel$model$k2, _rowViewModel$model$k3, _rowViewModel$model$k4, _rowViewModel$model$k5, _this$_durationVal, _rowViewModel$model$k6, _ref, _rowViewModel$model$s, _rowViewModel$model$s2, _this$_options$rowsSt;
            ...
            if (!isNaN(frameWidth) && frameWidth > 0) {
              ...
              for (var i = 0; i < maxFrames > totalFrames ? totalFrames : maxFrames; i++) {
